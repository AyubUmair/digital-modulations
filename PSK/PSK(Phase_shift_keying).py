...
class PSK(Phase_shift_keying)(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "PSK(Phase_shift_keying)")
        ...
        self.analog_random_source_x_0 = blocks.vector_source_i(list(map(int, numpy.random.randint(0, N, 1000))), True)
...
def main(top_block_cls=PSK(Phase_shift_keying), options=None):
